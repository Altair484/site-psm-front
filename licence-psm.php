...
<!--Losanges Formation-->
<section class="programme container-fluid">
                    ...
                    <div class="card-header" role="tab" id="headingOne">
                        <h5 class="mb-0">
                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                Collapsible Group Item #1 <i class="fa"></i>
                            </a>
                        </h5>
                    </div>
...
<div class="container-fluid" style="height: 200px; background-color: #0a86e9">
</div>

<footer>

</footer>
<script src="js/vendor/jquery-3.0.1.slim.min.js"></script>
